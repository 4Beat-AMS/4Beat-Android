...
import com.fourbeat.data.datasource.media.NotificationListenerPermissionLocalDataSource
...
internal object MediaModule {
    ...
    @Provides
    @Singleton
    fun providesNotificationListenerPermissionDataSource(
        @ApplicationContext context: Context,
    ): NotificationListenerPermissionDataSource =
        NotificationListenerPermissionLocalDataSource(context = context)
}
